//= Functions & Modules
// Own
export { default as createMultipleGetterRequest } from "./requests/createMultipleGetterRequest";
export { default as createSingleAdderRequest } from "./requests/createSingleAdderRequest";
export { default as createSingleDeleterRequest } from "./requests/createSingleDeleterRequest";
export { default as createSingleGetterRequest } from "./requests/createSingleGetterRequest";
