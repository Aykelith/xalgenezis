...
function preventMultipleCalls_createOnBegin(sessionVariableName : string, uniqueID : string, requestSettings : any) {
...
function preventMultipleCalls_createOnEnd(sessionVariableName : string, uniqueID : string, requestSettings : any) {
    return async (req : Request, data : any, sharedData : any) => {
